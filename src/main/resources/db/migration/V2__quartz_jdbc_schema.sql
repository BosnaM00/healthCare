-- ============================================================
-- V2 — Quartz JDBC JobStore schema (PostgreSQL)
-- ============================================================
-- Official Quartz 2.x PostgreSQL schema.
...
-- All statements are guarded with IF NOT EXISTS to be idempotent.
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_qrtz_ft_trig           ON qrtz_fired_triggers (sched_name, trigger_name, trigger_group);
